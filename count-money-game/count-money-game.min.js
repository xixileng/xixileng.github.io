...
/***/ function(module, exports) {
	...
	function CountMoneyGame() {
	  ...
	  // 优惠券
	  this.result_discount = 'http://cdn1.showjoy.com/images/14/14fbee40dcdf4edbaec2943dbc172614.png';
	  // 0元购物券
	  this.result_zero = 'http://cdn1.showjoy.com/images/79/79302c14e9d0422496cf489215bc22d0.png';
	  // 免单
	  this.result_free = 'http://cdn1.showjoy.com/images/cc/ccdf76eee5874050a26aa20bcd7b308c.png';
	  // 未满6900
	  this.result_nothing = 'http://cdn1.showjoy.com/images/7e/7e2d6bf5f9a2460c82a9c9592eeae958.png';
	  // 满6900未中奖
	  this.result_no_award = 'http://cdn1.showjoy.com/images/7f/7f6db036b6884d5bbad7aa005c0c7fb6.png';
	  this.result_url = '';
	  // 动画结束事件兼容性判断
	...
	CountMoneyGame.prototype = {
	  ...
	  countResult() {
	    ...
	    if (lastMoneyTotal >= 6900) {
	      $.getJSON('/m/api/shop/activity/drawLottery',{data: lastMoneyTotal}, (data) => {
	        // 据说这样更符合面向对象编程理念,重点是eslint对switch缩进判断很坑啊~~~
	        const resultType = {
	          '1': () => {
	            this.result_url = this.result_discount;
	            return '<span class="discount-count">'+data.count+
	              '</span><span class="discount-full">'+data.full+'</span>';
	          },
	          '2': () => {
	          ...
	          '4': () => {
	            this.result_url = this.result_zero;
	            return '';
	          },
	          '5': () => {
	            this.result_url = this.result_free;
	            return '<span class="free-content"><p class="free-order-number">免单单号 '+data.orderNumber+
	              '</p><p class="free-word">订单只针对活动期间的有效订单哦</p>'+
	              '<a href="javascript:void(0)" class="look-details">点击查看免单详情</a></span>';
	          }
	        };
	        document.getElementById('result-content-dom').innerHTML = resultType[data.type]();
	        this.showResult();
	      });
	    } else {
	      this.result_url = this.result_nothing;
	      ...
	      // this.result_url = this.result_discount;
	      // document.getElementById('result-content-dom').innerHTML =
	      //   '<span class="discount-count">15</span><span class="discount-full">满199元可用</span>';
	      this.showResult();
	    }
	  },
	  // 结果界面
	  showResult() {
	    ...
	    resultImg.onload = () => {
	      resultGroup.style.height = resultImg.height + 'px';
...
/***/ }
/******/ ]);
//# sourceMappingURL=count-money-game.min.js.map